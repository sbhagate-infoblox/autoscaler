...
var (
	...
	namespace               = flag.String("namespace", "cdc-data-flow", "Namespace in which cluster-autoscaler run.")
	...
	skipNodesWithSystemPods                 = flag.Bool("skip-nodes-with-system-pods", true, "If true cluster autoscaler will never delete nodes with pods from cdc-data-flow (except for DaemonSet or mirror pods)")
